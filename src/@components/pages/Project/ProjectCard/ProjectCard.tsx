...
const ProjectCard = ({ data }: { data: Project }) => {
  ...
  return (
    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.06] p-3 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:border-blue-400/40 hover:bg-white/10">
      ...
      <div className="relative h-52 w-full overflow-hidden rounded-2xl border border-white/10 bg-slate-950/40 sm:h-56">
        <Image
          src={image}
          alt={title}
          fill
      ...
      <div className="flex min-h-[210px] flex-col p-3 pt-5">
        ...
        <a
          ...
          className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-blue-400/30 bg-blue-500/10 px-5 py-3 text-sm font-bold text-blue-200 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-400/60 hover:bg-blue-500/20 hover:text-white"
        >
          See Details
